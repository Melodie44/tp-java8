...
public class Stream_03_Test {
    ...
    public void test_mapping() throws Exception {
        ...
        // TODO Construire la map Sexe -> Chaîne représentant les prénoms des clients
         ...
         Map<Gender, String> result = customers.stream().sorted((c1, c2) -> c1.getFirstname().compareTo(c2.getFirstname())).collect(groupingBy(Customer::getGender, mapping(Customer::getFirstname, joining("|"))));
